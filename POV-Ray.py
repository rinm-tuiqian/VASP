...
indice_Pb = [atom.index for atom in atoms if atom.symbol == 'Pb']
...
for o in indice_Cu:
	colors[o] = [205,175,149] / np.array([255.]) #[205 ,133, 63] / np.array([255.])
for p in indice_C:
...
for s in indice_Pb:
	colors[s]= [205 ,133, 63]/np.array([255.])#gray

#colors[108:126]=[210,105,30] / np.array([255.]) yellow
#colors[192]=[105,105,105] / np.array([255.])  #choose someone atom to highlight
